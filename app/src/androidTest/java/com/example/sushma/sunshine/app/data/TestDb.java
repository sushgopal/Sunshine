 ...
 */
package com.example.sushma.sunshine.app.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable() {
        ...
        ContentValues toInsert = TestUtilities.createNorthPoleLocationValues();

        // Insert ContentValues into database and get a row ID back
        long rowId = db.insert(WeatherContract.LocationEntry.TABLE_NAME, null, toInsert);

        // Query the database and receive a Cursor back
        Cursor rows = db.query(WeatherContract.LocationEntry.TABLE_NAME, null, null, null, null, null, null);
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Did not get what was inserted to Location table", rows, toInsert);
    ...
    public void testWeatherTable() {
        ...
        // the weatherData. Make sure to cover as many failure cases as you can.
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error in inserting and retrieving data from Weather table", cursor, weatherData);
